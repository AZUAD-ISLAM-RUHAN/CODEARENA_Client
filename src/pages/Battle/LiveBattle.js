    ...
    <div className="min-h-screen bg-gray-950 text-white flex flex-col">
      ...
      {battleStatus !== 'active' && (
        <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-50">
          <div className="bg-gray-900 border-2 border-yellow-400 rounded-2xl p-8 text-center max-w-md">
      ...
      <div className="flex-1 flex overflow-hidden">
        {/* Left Panel - Problem */}
        <div className="w-1/4 border-r border-gray-800 overflow-y-auto bg-gray-900">
          ...
          <div className="p-4 space-y-4">
            ...
            {problem.examples.map((ex, idx) => (
              <div key={idx} className="bg-gray-950 rounded p-3 text-xs">
                <div className="text-gray-500 mb-1">Example {idx + 1}:</div>
        ...
        <div className="w-1/2 flex flex-col bg-gray-900">
          ...
          <div className="flex items-center justify-between px-4 py-3 border-b border-gray-800">
            <select
              ...
              className="bg-gray-800 text-white border border-gray-700 rounded-lg px-3 py-1.5 text-sm focus:outline-none focus:border-yellow-400"
            >
              {languages.map((lang) => (
            ...
            <div className="flex items-center gap-2">
              <button
                ...
                onClick={handleRun}
                disabled={isRunning}
                className="bg-gray-700 hover:bg-gray-600 text-white font-medium px-4 py-1.5 rounded-lg transition text-sm disabled:opacity-50"
              >
                {isRunning ? '⏳' : '▶️'} Run
              </button>
              <button
          ...
          {/* Output Console */}
          {output && (
            <div className="h-40 border-t border-gray-800 bg-gray-950 overflow-y-auto">
              <div className="px-4 py-2 border-b border-gray-800 font-semibold text-sm flex items-center justify-between">
                <span>Output</span>
        ...
        <div className="w-1/4 border-l border-gray-800 bg-gray-900 flex flex-col">
          {/* Opponent Card */}
          <div className="p-4 border-b border-gray-800">
            <h3 className="text-sm font-semibold text-gray-400 mb-3 uppercase tracking-wider">Opponent</h3>
          ...
          {/* Your Progress */}
          <div className="p-4 border-b border-gray-800">
            <h3 className="text-sm font-semibold text-gray-400 mb-3 uppercase tracking-wider">Your Progress</h3>
            <div className="mb-2">
              <div className="flex justify-between text-xs mb-1">
          ...
          <div className="flex-1 overflow-y-auto p-4">
            <h3 className="text-sm font-semibold text-gray-400 mb-3 uppercase tracking-wider">Battle Log</h3>
